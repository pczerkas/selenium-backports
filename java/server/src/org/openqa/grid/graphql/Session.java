...
public class Session {
  ...
  public Session(String id, ImmutableCapabilities capabilities, Instant startTime, URI uri, String nodeId,
                 URI nodeUri, TestSlot slot) {
    this.id = Require.nonNull("Session id", id);
    this.capabilities = Require.nonNull("Session capabilities", capabilities);
    this.startTime = Require.nonNull("Session Start time", startTime);
    this.uri = Require.nonNull("Session uri", uri);
  ...
  // public org.openqa.grid.graphql.Slot getSlot() {
  //   return new org.openqa.grid.graphql.Slot(
